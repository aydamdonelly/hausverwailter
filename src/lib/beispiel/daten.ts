...
export const BEISPIEL_OBJEKTE: Objekt[] = [
  {
    ...
    auftraggeber: { name: "Wohnungseigentümergemeinschaft Am Stadtpark 3", zusatz: "vertreten durch die Verwaltung", adresse: { strasse: "Am Stadtpark 3", plz: "50674", ort: "Köln", land: "DE" }, email: "beirat.stadtpark@example.de", kundennummer: "K-1001", leitwegId: "" },
    honorarNettoMonat: null, verwaltungSeit: "2021-01-01", bankIban: "DE12500105170648489890", aktiv: true, notizen: "Zwei Aufzüge, Tiefgarage. Beiratsvorsitz: Herbert Klein.",
  },
  {
    ...
    auftraggeber: { name: "Erika Vogel", zusatz: "", adresse: { strasse: "Rösrather Straße 12", plz: "51107", ort: "Köln", land: "DE" }, email: "erika.vogel@example.de", kundennummer: "K-1002", leitwegId: "" },
    honorarNettoMonat: null, verwaltungSeit: "2023-04-01", bankIban: "DE41500105170123456789", aktiv: true, notizen: "Mietkonto läuft auf die Eigentümerin, Verwaltung hat Vollmacht.",
  },
  {
    ...
    auftraggeber: { name: "Wohnungseigentümergemeinschaft Rosenhof 5-7", zusatz: "vertreten durch die Verwaltung", adresse: { strasse: "Rosenhof 5", plz: "50823", ort: "Köln", land: "DE" }, email: "", kundennummer: "K-1003", leitwegId: "" },
    honorarNettoMonat: 1450, verwaltungSeit: "2019-07-01", bankIban: "DE75512108001245126199", aktiv: true, notizen: "Vertraglich fester Pauschalpreis.",
  },
  {
    ...
    auftraggeber: { name: "Familie Brandt GbR", zusatz: "z. Hd. Thomas Brandt", adresse: { strasse: "Luxemburger Straße 300", plz: "50939", ort: "Köln", land: "DE" }, email: "t.brandt@example.de", kundennummer: "K-1004", leitwegId: "" },
    honorarNettoMonat: null, verwaltungSeit: "2024-01-01", bankIban: "DE89370400440532013000", aktiv: true, notizen: "",
  },
  {
    ...
    auftraggeber: { name: "Wohnungseigentümergemeinschaft Severinstraße 88", zusatz: "vertreten durch die Verwaltung", adresse: { strasse: "Severinstraße 88", plz: "50678", ort: "Köln", land: "DE" }, email: "", kundennummer: "K-1005", leitwegId: "" },
    honorarNettoMonat: null, verwaltungSeit: "2022-10-01", bankIban: "DE27100777770209299700", aktiv: true, notizen: "Dachsanierung 2027 geplant.",
  },
];
...
export const BEISPIEL_PERSONEN: Person[] = [
  { id: "P-201", objektId: "OBJ-002", einheitId: "E-201", rolle: "mieter", anrede: "Frau", name: "Anna Schmidt", adresse: { strasse: "Bahnhofstraße 7", plz: "50667", ort: "Köln", land: "DE" }, email: "", telefon: "", ibans: ["DE21100110012626667882"], soll: { kalt: 720, nebenkosten: 180, hausgeld: 0, faelligTag: 3 }, seit: "2019-05-01", bis: null, aktiv: true, notizen: "" },
  ...
  { id: "P-204", objektId: "OBJ-002", einheitId: "E-204", rolle: "mieter", anrede: "Frau", name: "Petra Lang", adresse: { strasse: "Bahnhofstraße 7", plz: "50667", ort: "Köln", land: "DE" }, email: "", telefon: "", ibans: ["DE36700202700012345678"], soll: { kalt: 690, nebenkosten: 170, hausgeld: 0, faelligTag: 3 }, seit: "2017-11-01", bis: null, aktiv: true, notizen: "" },
  ...
  { id: "P-207", objektId: "OBJ-002", einheitId: "E-207", rolle: "mieter", anrede: "Frau", name: "Elif Demir", adresse: { strasse: "Bahnhofstraße 7", plz: "50667", ort: "Köln", land: "DE" }, email: "", telefon: "", ibans: ["DE59100100100057021049"], soll: { kalt: 700, nebenkosten: 175, hausgeld: 0, faelligTag: 3 }, seit: "2020-03-01", bis: null, aktiv: true, notizen: "Dauerauftrag ohne Verwendungszweck." },
  { id: "P-208", objektId: "OBJ-002", einheitId: "E-208", rolle: "mieter", anrede: "Herr", name: "Karl Fischer", adresse: { strasse: "Bahnhofstraße 7", plz: "50667", ort: "Köln", land: "DE" }, email: "", telefon: "", ibans: ["DE07100500000190001060"], soll: { kalt: 620, nebenkosten: 150, hausgeld: 0, faelligTag: 3 }, seit: "2015-01-01", bis: null, aktiv: true, notizen: "" },
...
/** Beispieldokumente, die in den Posteingang gelegt werden (liegen unter public/beispiel/). */
